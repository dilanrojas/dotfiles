...
ITEMS=(
  ...
  "󰍱  Env Config::$TERMINAL nvim $CFG/config/env.lua"
  "󰦪  Misc Config::$TERMINAL nvim $CFG/config/misc.lua"
  "󰌚  Permissions Config::$TERMINAL nvim $CFG/config/permissions.lua"
